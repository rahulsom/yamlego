 ...
 */
sealed class YamlegoEvent(
    private val stopSign: Class<out Event>?,
    firstEvent: Event,
) {
     ...
     */
    fun children(): List<YamlegoEvent> = children
     ...
     */
    fun isValid(): Boolean = isThisValid() && children.all { it.isValid() }
     ...
     */
    class YamlStream(
        startEvent: StreamStartEvent,
    ) : YamlegoEvent(StreamEndEvent::class.java, startEvent) {
     ...
     */
    class Document(
        startEvent: DocumentStartEvent,
    ) : YamlegoEvent(DocumentEndEvent::class.java, startEvent) {
        override fun isThisValid(): Boolean = events.size == 2
     ...
     */
    class Mappings(
        startEvent: MappingStartEvent,
    ) : YamlegoEvent(MappingEndEvent::class.java, startEvent) {
...
//    }
     ...
     */
    class Sequence(
        startEvent: SequenceStartEvent,
    ) : YamlegoEvent(SequenceEndEvent::class.java, startEvent) {
        override fun isThisValid(): Boolean = true
     ...
     */
    class Collection(
        startEvent: CollectionStartEvent,
    ) : YamlegoEvent(CollectionEndEvent::class.java, startEvent) {
        override fun isThisValid(): Boolean = true
     ...
     */
    class Comment(
        startEvent: CommentEvent,
    ) : YamlegoEvent(null, startEvent) {
        override fun isThisValid(): Boolean = true
